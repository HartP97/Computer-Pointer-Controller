...
class Fd_Network:
    ...
    def load_model(self, model, device="CPU"):
        ...
        try:
            ...
            log.error("Following error occurred while loading the face-detection model:" + str(e), exc_info=True)
    ...
    def get_input_shape(self):
        ...
        try:
            ...
            log.error("Following error occurred when getting input shape for face-detection model: " + str(e),
                      exc_info=True)
        return shape
    ...
    def async_inference(self, image):
        ...
        try:
            ...
            log.error("Following Error occurred during inference request for face-detection: " + str(e), exc_info=True)
        return
    ...
    def extract_output(self):
        ...
        try:
            ...
            log.error("Following error occurred while returning output for face-detection-model: " + str(e),
                      exc_info=True)
        return output
